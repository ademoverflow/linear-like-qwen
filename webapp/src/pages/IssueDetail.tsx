 ...
 * screens, the detail panel on the right; the panel is the full page on
 * narrow screens (brief §7.1, §7.4).
 */
export function IssueDetail() {
	...
	return (
		<div className="flex h-full">
			<div className="hidden w-2/5 min-w-80 max-w-md flex-col border-r border-neutral-200 bg-white md:flex dark:border-neutral-800 dark:bg-neutral-50">
