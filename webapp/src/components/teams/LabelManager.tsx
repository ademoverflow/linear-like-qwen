...
/**
 * Label management for a Team (ticket 05, brief §5.2/§9): create, rename,
 * recolor and delete. Shared by the Issues-list dialog and the Team
 * settings' Labels tab (ticket 08).
 */
export function LabelManager({ teamId }: { teamId: string }) {
	const queryClient = useQueryClient();
